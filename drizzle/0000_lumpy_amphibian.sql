...
CREATE TABLE "couples" (
	...
	"budget" integer DEFAULT 20000 NOT NULL,
...
CREATE TABLE "scenarios" (
	...
	"lieu_nom" text DEFAULT '' NOT NULL,
	"nb_invites" integer NOT NULL,
	"niveau" text NOT NULL,
	"cout_estime" jsonb NOT NULL,
...
ALTER TABLE "scenarios" ADD CONSTRAINT "scenarios_couple_id_couples_id_fk" FOREIGN KEY ("couple_id") REFERENCES "public"."couples"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
